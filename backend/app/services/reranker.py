...
RERANK_CALL_TIMEOUT = 60  # 단일 API 호출 최대 대기 시간(초)


class Reranker:
    def __init__(self, api_key: str, model: str, concurrency: int = 3):
    ...
    async def rerank(self, description: str, candidates: list[SearchCandidate], top_n: int, max_retries: int = 1) -> list[dict]:
